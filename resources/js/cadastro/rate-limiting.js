...
class CadastroRateLimitingCounter {
    ...
    disableForm() {
        ...
        if (this.elements.cadastroButton) this.elements.cadastroButton.textContent = 'Aguarde...';
        this.createOrShowAlert(this.remainingSeconds);
    }
    ...
    enableForm() {
        ...
        if (this.elements.cadastroButton) this.elements.cadastroButton.textContent = 'Cadastrar';
        this.hideAlert();
    ...
    saveState(seconds) {
        try {
            localStorage.setItem('cadastroRateLimitState', JSON.stringify({
